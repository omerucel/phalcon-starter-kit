...
sleep 2
yum --enablerepo=remi-php55,remi install -y gcc make php php-devel pcre-devel php-pear php-pecl-xdebug php-pecl-xhprof php-mysql php-pecl-memcached php-xml php-gd php-mbstring php-mcrypt php-fpm php-soap php-json
